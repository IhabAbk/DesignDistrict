...
function Badge({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center rounded-full border border-[rgba(234,179,8,0.35)] bg-[rgba(234,179,8,0.10)] px-2.5 py-0.5 text-[10px] tracking-wide text-[rgba(255,233,179,0.95)] sm:px-3 sm:py-1 sm:text-xs">
      {children}
    </span>
  );
}
...
function HeroBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div className="absolute -top-40 left-[-10%] h-[320px] w-[320px] rounded-full bg-[rgba(234,179,8,0.10)] blur-3xl sm:h-[420px] sm:w-[420px] md:h-[520px] md:w-[520px]" />
      <div className="absolute -bottom-48 right-[-12%] h-[360px] w-[360px] rounded-full bg-[rgba(234,179,8,0.08)] blur-3xl sm:h-[460px] sm:w-[460px] md:h-[560px] md:w-[560px]" />

      {/* Diagonal pattern - reduced opacity on mobile */}
      <div className="absolute inset-0 opacity-[0.08] sm:opacity-[0.18]">
      ...
      />
      <motion.div
        className="absolute left-[25%] top-[8%] h-0.5 w-0.5 rounded-full bg-[rgba(234,179,8,0.85)] shadow-[0_0_18px_rgba(234,179,8,0.65)] sm:left-[38%] sm:top-[12%] sm:h-1 sm:w-1"
...
function HeroArt() {
  return (
    ...
    >
      ...
      <div className="absolute -inset-3 rounded-[1.5rem] bg-[linear-gradient(135deg,rgba(234,179,8,0.16),transparent_55%)] blur-xl sm:-inset-4 sm:rounded-[2rem] md:-inset-6 md:rounded-[2.6rem] md:blur-2xl" />

      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] shadow-[0_20px_90px_rgba(0,0,0,0.65)] sm:rounded-3xl">
        ...
        <div className="relative h-[280px] w-full sm:h-[380px] md:h-[480px] lg:h-[520px]">
          ...
          {/* Decorative shapes - simplified on mobile */}
          ...
          {/* Scanning light - disabled on mobile for performance */}
          <motion.div
          ...
          {/* Bottom badge - responsive sizing */}
          <div className="absolute bottom-3 left-3 rounded-xl border border-white/10 bg-black/50 px-2 py-1.5 backdrop-blur sm:bottom-4 sm:left-4 sm:rounded-2xl sm:px-3 sm:py-2 md:bottom-6 md:left-6 md:px-4 md:py-3">
...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-4 pb-12 pt-12 sm:px-5 sm:pb-16 sm:pt-14 md:pt-20 lg:pt-24">
        <div className="grid items-center gap-6 sm:gap-8 md:gap-10 lg:grid-cols-2">
          ...
          >
            ...
            <motion.p 
              variants={item} 
              className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-white/70 sm:mt-4 sm:text-base lg:mx-0"
            >
            ...
            >
              <Link
                href="#services"
                className="rounded-full bg-gradient-to-r from-[#eab308] to-[#f5c518] px-5 py-2.5 text-sm font-semibold text-black shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-[0_0_25px_rgba(234,179,8,0.5)] sm:px-6 sm:py-3"
              >
                View Services
              </Link>
              <Link
                href="#contact"
                className="rounded-full border border-white/15 bg-white/[0.03] px-5 py-2.5 text-sm font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-white/[0.08] sm:px-6 sm:py-3"
              >
                Request a Quote
              </Link>
            </motion.div>
            ...
            <motion.div variants={item} className="mt-8 sm:mt-10">
              ...
              <div className="mt-4 flex flex-wrap justify-center gap-1.5 text-[10px] text-white/60 sm:gap-2 sm:text-xs lg:justify-start">
                <span className="rounded-full border border-white/10 bg-white/[0.03] px-2 py-1 transition-all duration-300 hover:border-[rgba(234,179,8,0.35)] hover:bg-[rgba(234,179,8,0.1)] hover:text-[#eab308] sm:px-3 sm:py-1">
                  Logo
                </span>
                <span className="rounded-full border border-white/10 bg-white/[0.03] px-2 py-1 transition-all duration-300 hover:border-[rgba(234,179,8,0.35)] hover:bg-[rgba(234,179,8,0.1)] hover:text-[#eab308] sm:px-3 sm:py-1">
                  Business Cards
